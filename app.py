...
def main():
    ...
    ret = sidebar()
    genreId = {'レディースファッション': 100371,'メンズファッション': 551177,'バッグ・小物・ブランド雑貨': 216131,'ジュエリー・アクセサリー': 216129, '日用品雑貨・文房具・手芸': 215783, 'おもちゃ': 566382,'スポーツ・アウトドア':101070,'家電':562637,'食品':100227,'スイーツ・お菓子':551167,'インテリア・寝具・収納':100804,'キッチン用品・食器・調理器具':558944,'ホビー':101164,'ダイエット・健康':100938}
    ...
    if ret is not None:
        ...
        Search_info.append(genreId[ret[1]])
